...
export function StatsCards({ stats }: StatsCardsProps) {
    const cards = [
        ...
        },
        {
            ...
            icon: Ticket,
            trend: stats.openTickets > 0 ? 'Needs Attention' : 'All clear',
            trendColor: stats.openTickets > 0 ? 'text-amber-600' : 'text-emerald-600',
            iconBg: 'bg-amber-100',
        ...
        },
        {
            ...
            trendColor: stats.pendingVerifications > 0 ? 'text-blue-600 font-medium' : 'text-slate-500',
            iconBg: 'bg-blue-100',
            iconColor: 'text-blue-600',
        },
    ]
